...
export default function MenuNavbarV2({
  ...
  return (
    <div
      className={`backdrop-blur-md transition-all duration-200 ${isScrolled ? 'py-2' : 'py-3'} sm:${isScrolled ? 'py-2.5' : 'py-4'} px-3 sm:px-4 flex items-center`}
      style={{
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center min-w-0">
        <span
          className="font-display font-bold truncate transition-all duration-200 text-base sm:text-lg"
          style={{ color: 'var(--sunday-text, #1c1c17)' }}
        >
          {restaurant.name}
        </span>
