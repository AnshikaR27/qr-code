  ...
  return (
    ...
    >
      <div
        ...
        className={`flex items-start gap-3 sm:gap-4 p-3 sm:p-3.5 rounded-xl ${dish.is_available ? 'cursor-pointer' : 'cursor-default'}`}
        style={{
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            />
            <h3
              className="font-body text-[15px] sm:text-base font-semibold leading-tight line-clamp-2"
          ...
          {/* Price */}
          <p className="font-body text-[13px] sm:text-[15px] font-medium mb-1 sm:mb-1.5" style={{ color: 'var(--sunday-text, #1c1c17)' }}>
            ₹{dish.price}
          </p>

          {/* Description */}
          {dish.description && (
            <p className="font-body text-[12px] sm:text-[13px] leading-relaxed line-clamp-2" style={{ color: 'var(--sunday-text-muted, #7A6040)' }}>
              {dish.description}
            </p>
          )}
        ...
        <div className="relative shrink-0">
          <div
            className="w-[100px] h-[100px] sm:w-[128px] sm:h-[128px] rounded-xl overflow-hidden flex items-center justify-center select-none"
          ...
          {dish.is_available && (
            ...
            >
              {qty === 0 ? (
                <button
                  onClick={handleAdd}
                  className="w-9 h-9 sm:w-11 sm:h-11 rounded-full text-white border-2 border-white cursor-pointer flex items-center justify-center leading-none active:scale-90 transition-transform duration-100"
                  style={{
