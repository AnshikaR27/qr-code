    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Content */}
          <div className={`${dish.image_url ? 'pt-4 sm:pt-5' : 'pt-10 sm:pt-12'} px-4 sm:px-5 pb-32 sm:pb-36`}>
            {/* Orderable badge */}
            ...
            {/* Dish name */}
            <h2 className="font-display text-xl sm:text-2xl font-bold leading-tight mb-1.5 sm:mb-2" style={{ color: 'var(--sunday-text, #1c1c17)' }}>
              {primaryName}
            </h2>

            {/* Description */}
            {dish.description && (
              <p className="font-body text-[13px] sm:text-sm leading-relaxed mb-3 sm:mb-4" style={{ color: 'var(--sunday-text-muted, #7A6040)' }}>
                {dish.description}
              </p>
            )}

            {/* Price */}
            <p className="font-body text-base sm:text-lg font-semibold mb-4 sm:mb-5" style={{ color: 'var(--sunday-text, #1c1c17)' }}>
              ₹{dish.price}
            </p>
          ...
          {dish.is_available ? (
            <div
              className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] border-t px-4 sm:px-5 py-3 sm:py-4 flex items-center gap-2.5 sm:gap-3 z-[101]"
              style={{
                backgroundColor: 'var(--sunday-card-bg, #FFFFFF)',
            ...
            >
              ...
              >
                <button
                  ...
                  className="w-9 h-10 sm:w-11 sm:h-12 bg-transparent border-none text-lg sm:text-xl font-light cursor-pointer flex items-center justify-center"
                  style={{ color: 'var(--sunday-text, #1c1c17)' }}
                >
                  −
                </button>
                <span className="w-7 sm:w-8 text-center font-body text-sm sm:text-base font-bold" style={{ color: 'var(--sunday-text, #1c1c17)' }}>
                  {localQty}
                </span>
                <button
              ...
              <button
                ...
                className="flex-1 py-3 sm:py-4 rounded-full text-white font-body text-[13px] sm:text-[15px] font-bold border-none cursor-pointer"
