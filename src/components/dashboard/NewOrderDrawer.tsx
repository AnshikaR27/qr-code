...
export default function NewOrderDrawer({ tableId, tableLabel, round, onClose, onOrderPlaced }: NewOrderDrawerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      {/* Drawer panel */}
      <div className="relative ml-auto w-full max-w-xl md:max-w-2xl h-full bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-200">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b bg-white">
          <div>
            <h2 className="font-bold text-lg">
              {round && round > 1 ? `Adding Round ${round}` : 'New Order'}
            </h2>
        ...
        {loading ? (
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            {cart.length > 0 && (
              <div className="hidden md:flex w-64 border-l bg-gray-50 flex-col">
                ...
                <div className="p-3 border-t space-y-2">
                  ...
                  <Button className="w-full" size="sm" onClick={placeOrder} disabled={placing}>
        ...
        {!loading && cart.length > 0 && (
          <div className="md:hidden border-t bg-white pb-[env(safe-area-inset-bottom)]">
