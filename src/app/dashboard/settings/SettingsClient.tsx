    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <Section title="Service Style">
          <p className="text-xs text-muted-foreground -mt-1">
            How do customers receive their orders? This changes what your customers see on their order tracking screen.
          </p>
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={cn(
                ...
                serviceMode === 'self_service' ? 'border-primary bg-primary/5' : 'border-border'
              )}
            >
            ...
            <button
              ...
              className={cn(
                'relative rounded-xl border-2 p-4 text-left transition-colors',
                serviceMode === 'table_service' ? 'border-primary bg-primary/5' : 'border-border'
              )}
            >
